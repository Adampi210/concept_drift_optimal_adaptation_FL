...
# Domain drift object
pacs_drift = DomainDrift(
    data_handler,
    source_domains=['RealWorld'],
    target_domains=['RealWorld'],
    drift_rate=0.25,
    desired_size=160
)
...
test_loader = agent.get_test_loader(test_size=0.1)
...
# target_sequence = ['svhn', 'syn', 'mnist', 'mnist_m']
target_sequence = ['RealWorld', 'Clipart', 'Product', 'Art']
counter = 1
