...
class OfficeHomeNet(BaseModelArchitecture):
    def __init__(self, num_classes=65):
        ...
        self.model = _resnet18(num_classes=num_classes)
...
def main():
    ...
    parser.add_argument('--models', type=str, nargs='+', default=['OfficeHomeNet',],
                        help='Models to train')
    parser.add_argument('--domains', type=str, nargs='+', default=['RealWorld', 'Clipart', 'Product', 'Art'],
                        help='Domains to train on')
    parser.add_argument('--num_epochs', type=int, default=1000, help='Number of update steps')
