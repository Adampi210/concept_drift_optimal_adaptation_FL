...
class DriftScheduler:
    SCHEDULE_CONFIGS = {
        ...
        "step_0": lambda: {
            ...
            'step_domains': ['svhn', 'mnist', 'syn', 'svhn'],
            'strategy': 'replace'
        },
        "step_1": lambda: {
...
settings = {
        ...
        69: {'pi_bar': 0.1, 'V': 10, 'L_i': 0, 'K_p': 10.0, 'K_d': 1.0, 'lr': 0.01, 'n_steps':1},
        70: {'pi_bar': 0.1, 'V': 10, 'L_i': 0, 'K_p': 1.0, 'K_d': 0.5, 'lr': 0.01, 'n_steps':1},
        71: {'pi_bar': 0.1, 'V': 10, 'L_i': 0, 'K_p': 0.4, 'K_d': 0.1, 'lr': 0.01, 'n_steps':1},
        72: {'pi_bar': 0.1, 'V': 10, 'L_i': 0, 'K_p': 1.0, 'K_d': 0.5, 'lr': 0.01, 'n_steps':1},
        73: {'pi_bar': 0.1, 'V': 10, 'L_i': 0, 'K_p': 1.5, 'K_d': 0.5, 'lr': 0.01, 'n_steps':1},
        74: {'pi_bar': 0.1, 'V': 10, 'L_i': 0, 'K_p': 1.25, 'K_d': 0.1, 'lr': 0.01, 'n_steps':1},
        75: {'pi_bar': 0.1, 'V': 10, 'L_i': 0, 'K_p': 2.0, 'K_d': 0.1, 'lr': 0.05, 'n_steps':1},
        76: {'pi_bar': 0.1, 'V': 10, 'L_i': 0, 'K_p': 2.5, 'K_d': 0.1, 'lr': 0.05, 'n_steps':1},
        77: {'pi_bar': 0.1, 'V': 10, 'L_i': 0, 'K_p': 2.0, 'K_d': 0.5, 'lr': 0.05, 'n_steps':1},
        78: {'pi_bar': 0.1, 'V': 10, 'L_i': 0, 'K_p': 2.5, 'K_d': 0.5, 'lr': 0.05, 'n_steps':1},
