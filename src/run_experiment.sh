...
# configurations of source domains, target domains, policies, setting IDs, seeds,
# and drift schedules.
...
# ========== RUN EXPERIMENTS ==========
# Outer loops: for each source domain set, target domain set, policy, setting, seed, and schedule
            ...
            for SETTING_ID in "${SETTING_IDS[@]}"; do
                for seed in "${seeds[@]}"; do
                    for schedule in "${SCHEDULES[@]}"; do
                        ...
                        # Construct a unique log filename including schedule type
                        ...
                        echo "  Schedule Type  : ${schedule}"
                        echo "  Seed           : ${seed}"
                        echo "  Log file       : ${log_file}"
                        echo "=========================================="
                        
                        # Execute the Python experiment script with schedule type
